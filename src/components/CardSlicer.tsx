...
export default function CardSlicer({ products, title, noPadding = false }: CardSliceProps) {
  ...
  return (
    <div
      className={`w-full max-w-full overflow-hidden sm:px-12 md:max-w-6xl md:mx-auto ${noPadding ? '' : 'px-4'}`}
    >
      ...
      {/* Área dos Cards */}
      <div
        className={`w-full max-w-full overflow-hidden ${noPadding ? 'sm:overflow-visible' : 'px-0 sm:px-0'}`}
      >
        <div
