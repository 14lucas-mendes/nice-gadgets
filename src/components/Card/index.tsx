    ...
    <div className='flex flex-col'>
      <div className="w-[272px] h-[506px] bg-white rounded-lg border border-slate-400 shadow-md">
        <div className='px-8 py-8 flex flex-col gap-2'>
          <div className='w-[208px] h-[196px] flex md:hover:scale-105 md:transition-transform md:duration-300 md:ease-in-out'>
            <Image
              src={`/${image}`}
              alt={name}
              width={208}
          ...
          <div className='flex flex-row gap-2 font-bold text-[14px] mt-4'>
            ...
            >
              <svg 
                ...
                strokeWidth={1.5} 
                stroke="currentColor" 
                className={`size-6 ${favorite ? 'text-red-500' : 'text-[#0F0F11]'}`}
              >
